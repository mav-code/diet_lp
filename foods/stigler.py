"""
diet_lp/foods/stigler.py

Stigler (1945) commodity set — 65 ingredients.

Calories, protein, calcium, iron, thiamine, riboflavin, niacin, and vitamin C
are derived from the 1939 US price data used in Stigler's diet problem
(https://developers.google.com/optimization/lp/stigler_diet), converted from
per-dollar values to per-100g values.

Carbs, fat, sodium, cholesterol, fiber, potassium, magnesium, zinc, b12, and
folate are from USDA FoodData Central SR Legacy (per 100g).

Foods already in usda.py are omitted to avoid duplicates: Milk, Eggs,
Cheese (Cheddar), Peanut Butter, Apples, Bananas, Oranges, Rolled Oats,
Sweet Potatoes, Spinach, Carrots, Onions.
"""
...
INGREDIENTS = [
    ...
    # --- Miscellaneous ---
    # Coffee and Tea values are for brewed beverage (100ml ≈ 100g).
    {
        "name": "Coffee",
        "unit": "100g",
        "grams": 100,
